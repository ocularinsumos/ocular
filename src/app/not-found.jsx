...
<div className="bg-[#eae6db]   w-full px-4 md:pt-10 pt-5 pb-16" id="faq">
  ...
  <img loading='lazy'  src='images/404/404.webp'  alt="ruta no encontrada 404"  width={1920}  height={1080} quality={75} sizes="100vw" className="w-[350px] md:w-4/12 justify-center text-center mx-auto"/>
