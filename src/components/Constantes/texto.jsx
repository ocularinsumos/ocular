const texto = {
    ...
    inicio: {
        ...
        descripcion:'Tenemos 23 Años en el mercado de Insumos Quirurgicos para Profesionales y Particulares.'
    },
    productos:{
      titulo:'Productos',
    ...
    contacto:{
      btn:'CONTACTO',
      title:'Contactanos por aca o comunícate por Whatsapp',
      nombre:'Nombre',
      email:'Tu Email',
      motivo:'Motivo',
      opciones:{
        opc1:'Seleccione una opción',
        opc2:'Consulta',
        opc3:'Precios',
        opc4:'Marcas',
        opc5:'Envios'
