...
export default function Navbar() {
  ...
  return (
    <div className="py-[32px] lg:py-[48px]">
      <Disclosure
        as="nav"
        className={`fixed top-0 left-0 right-0 sm:py-0 md:py-4 bg-primary text-text-tertiary border-neutral-200 backdrop-blur-sm z-20`}
      >
        {({ open }) => (
          <>
                        ...
                        <Link
                          ...
                          className={classNames(
                            activeLink === item.href
                              ? "text-white font-latoRegular relative inline-block group"
                              : "text-textLigth relative inline-block group"
                          )}
                          aria-current={
