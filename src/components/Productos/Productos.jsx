    ...
    <div id="productos">
      ...
      <div className="flex justify-evenly my-10 md:px-0 flex-wrap md:mx-10">
        {producto.map((servicio, i) => (
          <Link href={`/${locale}/${servicio.id}`} key={i} className="flex flex-col items-center text-center w-1/2 md:w-1/4 mb-10 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg active:scale-110 active:duration-75">
